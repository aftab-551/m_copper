    ...
    <footer className="bg-dark text-white pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              For any type of metal, steel, aluminium, or copper. Get instant
              cash from your desired location. We guarantee the best rates in
              the market. For Melbourne and its surrounding suburbs.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 text-center text-gray-500 text-sm flex justify-center space-x-4">
          <p>
            © {new Date().getFullYear()} Martika Copper Refinery. All rights
            reserved.
          </p>
          <p>
